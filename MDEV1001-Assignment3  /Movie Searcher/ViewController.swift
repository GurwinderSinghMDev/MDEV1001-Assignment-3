...
class ViewController: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet var searchButton: UIButton! // Add the search button to your storyboard and connect it here
    ...
    // Add the action for the search button
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        URLSession.shared.dataTask(with: URL(string: "https://www.omdbapi.com/?apikey=f82acf5e&i=\(imdbID)")!,
                                   completionHandler: { data, response, error in
